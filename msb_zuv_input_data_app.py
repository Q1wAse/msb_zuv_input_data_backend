...
from msb_zuv_input_data_backend.namespaces.ns_bud_st import ns_bud_st
from msb_zuv_input_data_backend.namespaces.ns_korr import ns_korr
...
api.add_namespace(ns_korr, path='')
api.add_namespace(ns_bud_st, path='')
#===================================================================================================================
application = app
